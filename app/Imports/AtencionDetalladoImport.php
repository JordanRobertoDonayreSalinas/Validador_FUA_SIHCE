...
class AtencionDetalladoImport implements ToModel, WithHeadingRow, WithBatchInserts, WithChunkReading
{
    ...
    public function model(array $row)
    {
        ...
        // DEBUG: Imprimir las llaves de la primera fila para ver los nombres reales de las columnas
        if (!isset($GLOBALS['debug_import_keys_printed'])) {
            \Log::info('Import Keys:', array_keys($row));
            $GLOBALS['debug_import_keys_printed'] = true;
        }
        ...
        return new FuaAtencionDetallado([
            ...
            'cod_prestacion' => $row['cod_prestacion'] ?? $row['cod_prestacional'] ?? null, // Intentar ambas columnas
